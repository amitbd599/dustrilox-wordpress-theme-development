...
function dustrilox_scripts() {
    ...
    */
    ...
    wp_enqueue_script( 'magnific-popup', DUSTRILOX_THEME_JS_DIR . 'magnific-popup.js', [ 'jquery' ], false, true );
    wp_enqueue_script( 'parallax', DUSTRILOX_THEME_JS_DIR . 'parallax.js', [ 'jquery' ], false, true );
    wp_enqueue_script( 'backtotop', DUSTRILOX_THEME_JS_DIR . 'backtotop.js', [ 'jquery' ], false, true );
    wp_enqueue_script( 'nice-select', DUSTRILOX_THEME_JS_DIR . 'nice-select.js', [ 'jquery' ], false, true );
    ...
    wp_enqueue_script( 'isotope-pkgd', DUSTRILOX_THEME_JS_DIR . 'isotope-pkgd.js', [ 'jquery' ], false, true );
    wp_enqueue_script( 'imagesloaded-pkgd', DUSTRILOX_THEME_JS_DIR . 'imagesloaded-pkgd.js', [ 'imagesloaded' ], false, true );


    wp_enqueue_script( 'dustrilox-main', DUSTRILOX_THEME_JS_DIR . 'main.js', [ 'jquery' ], time(), true );
