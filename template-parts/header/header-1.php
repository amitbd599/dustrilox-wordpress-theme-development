               ...
               <div class="row align-items-center">
                  ...
                  <div class="col-xl-3 col-lg-4 d-none d-lg-block">
                     <div class="header-info f-right">
                        ...
                        <h5>
                           <a href="tel:<?php echo esc_attr( $dustrilox_phone_num ); ?>">
                           <?php echo esc_html($dustrilox_phone_num );?></a>
                        </h5>
                        ...
                        <h5>
                           <a href="mailto:<?php echo esc_attr( $dustrilox_mail_id, 'dustrilox') ?>">
                           <?php echo esc_html( $dustrilox_mail_id) ?></a>
                        </h5>
                           </div>
                           <?php endif;?>
                     </div>
