<?php
   ...
   */
    ...
    $dustrilox_image_gallery = get_theme_mod( 'dustrilox_side_gallery_setting' );
        ...
        <div class="sidebar__content">
            ...
            <div class="sidebar__logo mb-40">
                <a href="<?php print esc_url( home_url( '/' ) );?>">
                    <img src="<?php echo esc_url( $dustrilox_side_logo );?>"
                ...
                <div class="row gx-2">
                    ...
                    <div class="col-4">
                        <div class="sidebar__single-img w-img mb-10">
                            <a class="popup-image" href="<?php echo $image['dustrilox_gallery_image']  ;?>">
                                <img src="<?php echo  $image['dustrilox_gallery_image']  ; ?>"
                                    alt="<?php print esc_attr__( 'Client', 'dustrilox' ); ?>">
                            </a>
                        </div>
                    </div>
                    <?php endforeach ;?>
                ...
                <ul>
                    ...
                    <li class="d-flex align-items-center">
                        ...
                        <div class="sidebar__contact-text">
                            <a target="_blank"
                                href="<?php echo esc_url( $dustrilox_extra_map )?>"><?php echo esc_html( $dustrilox_extra_address )?></a>
                        </div>
                    </li>
                    <?php endif ;?>
                    ...
                    <li class="d-flex align-items-center">
                        ...
                        <div class="sidebar__contact-text">
                            <a
                                href="tel:<?php echo esc_attr( $dustrilox_extra_phone ); ?>"><?php echo esc_html( $dustrilox_extra_phone ); ?></a>
                        </div>
                    </li>
                    <?php endif ;?>
                    ...
                    <li class="d-flex align-items-center">
                        ...
                        <div class="sidebar__contact-text">
                            <a
                                href="mailto:<?php echo esc_attr( $dustrilox_extra_email )?>"><?php echo esc_html( $dustrilox_extra_email )?></a>
                        </div>
                    </li>
                    <?php endif ;?>
                </ul>
