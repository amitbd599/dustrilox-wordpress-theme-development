<?php
	...
	*/
    ...
    $dustrilox_header_feed = get_theme_mod( 'dustrilox_header_feed', __( 'Our company is one of the', 'dustrilox' ) );
    ...
    $dustrilox_phone_num = get_theme_mod( 'dustrilox_phone_num', __( '+88-96-9652', 'dustrilox' ) );
            ...
            <div class="container">
               <div class="row align-items-center">
                  <div class="col-xl-7 col-lg-7 col-md-7">
                     ...
                     <?php if(!empty($dustrilox_header_feed)) : ?>
                        <p class="header__top-info-text"><span><?php echo esc_html__('Feed:', 'dustrilox');?></span><?php echo esc_html( $dustrilox_header_feed ); ?></p>
                        <?php endif;?>
                     ...
                     <?php if(!empty($dustrilox_address)) : ?>
                        <div class="header__smcontact-list">
                           ...
                           <div class="sm-clist__text">
                              <h4><a href="https://goo.gl/maps/2McRmWEFCW8nj9p16" target="_blank">
                        ...
                        <div class="header__smcontact-list">
                           ...
                           <div class="sm-clist__text">
                              <h4><a href="tel:<?php echo esc_attr( $dustrilox_phone_num ); ?>">
                           <?php echo esc_html($dustrilox_phone_num );?></a></h4>
