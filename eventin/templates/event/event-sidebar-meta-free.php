    ...
    <div class="events__info">
        ...
        <div class="events__info-meta mb-25 d-flex align-items-center justify-content-between">
            <div class="events__info-price">
                <h4 class="sidebar__widget-title"><?php echo esc_html__('Event Info ', "dustrilox"); ?> </h4>
            </div>
        </div>
        <div class="events__info-content mb-0">
			...
			?>
                <li class="d-flex align-items-center">
                    ...
                    <div class="event__info-item">
                        <h5><span><?php echo esc_html__('Date : ', "dustrilox"); ?> </span>
			...
			?>
                <li class="d-flex align-items-center">
                    ...
                    <div class="event__info-item">
                        <h5><span><?php echo esc_html__('Reg. Deadline : ', "dustrilox"); ?> </span>
            ...
            <ul>
               ...
               ?>
                <li class="d-flex align-items-center">
                    ...
                    <div class="event__info-item">
                        <h5><span><?php echo esc_html__('End: ', 'dustrilox'); ?></span> <?php echo esc_html($data['event_end_date']); ?></h5>
                    </div>
                </li>
                <?php endif; ?>
               ...
               ?>
                <li class="d-flex align-items-center">
                    ...
                    <div class="event__info-item">
                        <h5><span><?php echo esc_html__('Time:', 'dustrilox'); ?></span> <?php echo esc_html($data['event_start_time'] . $separate . $data['event_end_time']); ?></h5>
                    </div>
                </li>
                <?php endif; ?>
               ...
               ?>
                <li class="d-flex align-items-center">
                    ...
                    <div class="event__info-item">
                        <h5><span><?php echo esc_html__('Venue: ', 'dustrilox'); ?></span> <?php echo esc_html($data['etn_event_location']);  ?></h5>
                    </div>
                </li>
                <?php endif; ?>
